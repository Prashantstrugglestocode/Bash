...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
      # Calculate the effective exchange rate including the spread
    effective_rate = exchange_rate * (1 + spread / 100)
    
    # Calculate the total amount of foreign currency you can afford
    total_foreign_currency = budget / effective_rate
    
    # Calculate how many bills of the given denomination you can get
